...
- Coordinated family release aligned with adapter dependency updates in 1.1.2.
...
- Documented the Avalonia, Consolonia, .NET MAUI, ProGPU, WPF, and WinUI 3 adapter packages.
